...
typedef enum {
    CPEqualArgument1,
    CPEqualArgument2,
    CPEqualNumberOfArguments
} CPEqualArguments;

@implementation CPEqual
...
- (id<CPValue>)calculateResult {
    CPRightValueWeakTypeArgument *argument1 = [self.syntaxOrderArguments objectAtIndex:CPEqualArgument1];
    CPRightValueWeakTypeArgument *argument2 = [self.syntaxOrderArguments objectAtIndex:CPEqualArgument2];
