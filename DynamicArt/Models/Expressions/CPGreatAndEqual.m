...
typedef enum {
    CPGreatAndEqualArgument1,
    CPGreatAndEqualArgument2,
    CPGreatAndEqualNumberOfArguments
} CPGreatAndEqualArguments;

@implementation CPGreatAndEqual
...
- (id<CPValue>)calculateResult {
    CPRightValueWeakTypeArgument *argument1 = [self.syntaxOrderArguments objectAtIndex:CPGreatAndEqualArgument1];
    CPRightValueWeakTypeArgument *argument2 = [self.syntaxOrderArguments objectAtIndex:CPGreatAndEqualArgument2];
